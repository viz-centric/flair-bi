...
public class DatasourcesResourceTest extends AbstractIntegrationTest {
	...
	public void createDatasources() {
		...
		ResponseEntity<Datasource> response = restTemplate
				...
				.exchange(getUrl() + "/api/datasources", HttpMethod.POST, new HttpEntity<>(datasource), Datasource.class);
	...
	public void updateDatasourcesCreatesDatasource() {
		...
		ResponseEntity<Datasource> response = restTemplate
				.withBasicAuth("flairuser", "flairpass")
				.exchange(getUrl() + "/api/datasources", HttpMethod.PUT, new HttpEntity<>(datasource), Datasource.class);
	...
	public void updateDatasources() {
		...
		ResponseEntity<Datasource> response = restTemplate
				.withBasicAuth("flairuser", "flairpass")
				.exchange(getUrl() + "/api/datasources", HttpMethod.PUT, new HttpEntity<>(datasourceWithId), Datasource.class);
	...
	public void getAllDatasourceById() {
		...
		ResponseEntity<Datasource> response = restTemplate
				.withBasicAuth("flairuser", "flairpass")
				.exchange(getUrl() + "/api/datasources/3", HttpMethod.GET, new HttpEntity<>(datasourceWithId), Datasource.class);
	...
	public void deleteDatasources() {
		ResponseEntity<String> response = restTemplate
				.withBasicAuth("flairuser", "flairpass")
				.exchange(getUrl() + "/api/datasources/3", HttpMethod.DELETE, new HttpEntity<>(new LinkedMultiValueMap<>()), String.class);
	...
	public void getCount() {
		...
		ResponseEntity<CountDTO> response = restTemplate
				.withBasicAuth("flairuser", "flairpass")
				.exchange(getUrl() + "/api/datasources/count", HttpMethod.GET, new HttpEntity<>(new LinkedMultiValueMap<>()), CountDTO.class);
	...
	public void deleteDatasourcesByPredicate() {
		ResponseEntity<String> response = restTemplate
				.withBasicAuth("flairuser", "flairpass")
				.exchange(getUrl() + "/api/datasources", HttpMethod.DELETE, new HttpEntity<>(new LinkedMultiValueMap<>()), String.class);
	...
	public void getDatasourceDeleteInfo() {
		...
		ResponseEntity<DeleteInfo[]> response = restTemplate
				.withBasicAuth("flairuser", "flairpass")
				.exchange(getUrl() + "/api/datasources/3/deleteInfo", HttpMethod.GET, new HttpEntity<>(new LinkedMultiValueMap<>()), DeleteInfo[].class);
	...
	public void listTables() {
		...
		ResponseEntity<ListTablesResponseDTO> response = restTemplate
				.withBasicAuth("flairuser", "flairpass")
				.exchange(getUrl() + "/api/datasources/listTables", HttpMethod.POST, new HttpEntity<>(request), ListTablesResponseDTO.class);
	...
	public void getSearchedDatasources() {
		...
		ResponseEntity<Datasource[]> response = restTemplate
				.withBasicAuth("flairuser", "flairpass")
				.exchange(getUrl() + "/api/datasources/search", HttpMethod.GET, new HttpEntity<>(new LinkedMultiValueMap<>()), Datasource[].class);
