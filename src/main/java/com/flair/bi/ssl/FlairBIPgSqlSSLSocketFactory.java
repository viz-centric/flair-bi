 ...
 * <p>
 * 1. FLAIRBI_PGSQL_TRUST_STORE_PATH - path of the trust store containing CA certificate
 * 2. FLAIRBI_PGSQL_TRUST_STORE_PASS - password for the trust store above
 * 3. FLAIRBI_PGSQL_KEY_STORE_PATH - path of the key store that contains flair bi certificate
 * 4. FLAIRBI_PGSQL_KEY_STORE_PASS - password for the keystore above
 * 5. FLAIRBI_PGSQL_KEY_PASS - password for the key that is binded to flair bi certificate
 * <p>
