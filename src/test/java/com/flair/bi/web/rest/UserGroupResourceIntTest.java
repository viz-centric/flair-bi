...
public class UserGroupResourceIntTest extends AbstractIntegrationTest {
    ...
    public void getAllUserGroups() throws Exception {
    	restUserGroupMockMvc.perform(get("/api/userGroups?page=0&size=5"))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
    ...
    public void getUserGroup() throws Exception {   	
    	restUserGroupMockMvc.perform(get("/api/userGroups",ROLE_ADMIN))
        .andExpect(status().isOk());
    }
    ...
    public void deleteUserGroup() throws Exception {
        ...
        restUserGroupMockMvc.perform(delete("/api/userGroups/{name}", ROLE_NAME)
    ...
    public void getDashboardPermissionMetadataUserGroup() throws Exception {    	
        ...
        restUserGroupMockMvc.perform(get("/api/userGroups/{name}/dashboardPermissions?page=0&size=20&id="+dashboard.getId(),ROLE_ADMIN))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
    ...
    public void getViewPermissionMetadataUserGroup() throws Exception {    	
        ...
        restUserGroupMockMvc.perform(get("/api/userGroups/{name}/dashboardPermissions/{id}/viewPermissions",ROLE_ADMIN,dashboard.getId()))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
        .andExpect(jsonPath("$.[*].grantee.name").value(hasItem(ROLE_ADMIN)))
