...
public class User extends AbstractAuditingEntity implements Serializable, PermissionGrantee {
    ...
    @JoinTable(
        ...
        inverseForeignKey = @ForeignKey(name = "fk_user_group_name"),
        joinColumns = {@JoinColumn(name = "user_id", referencedColumnName = "id")},
        inverseJoinColumns = {@JoinColumn(name = "user_group_name", referencedColumnName = "name")})
    ...
    @JoinTable(
        ...
        foreignKey = @ForeignKey(name = "fk_usr_perm_user_id"),
        inverseForeignKey = @ForeignKey(name = "fk_usr_perm_permission_key"),
        joinColumns = {
     ...
     *
     * @param onlyUserGroup only include permissions from user group if true, otherwise all
     * @return list of all permissions
     */
    public Set<Permission> retrieveAllUserPermissions(boolean onlyUserGroup) {
        Set<Permission> permissions = new HashSet<>();

        getUserGroups().forEach(x ->
    ...
    public Set<Permission> getPermissionsByActionAndPermissionType(Collection<Action> action, String scope) {
        return this.retrieveAllUserPermissions()
            .stream()
