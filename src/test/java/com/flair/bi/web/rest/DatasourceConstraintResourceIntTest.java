...
public class DatasourceConstraintResourceIntTest extends AbstractIntegrationTest {
	...
	private static final ConstraintDefinition DEFAULT_CONSTRAINT_DEFINITION = new ConstraintDefinition(
			Collections.singletonList(new ExclusionFeatureConstraintExpression()));
	private static final ConstraintDefinition UPDATED_CONSTRAINT_DEFINITION = new ConstraintDefinition(
			Collections.singletonList(new InclusionFeatureConstraintExpression()));
	...
	public void setup() {
		...
		DatasourceConstraintResource datasourceConstraintResource = new DatasourceConstraintResource(
	...
	public void createDatasourceConstraint() throws Exception {
		...
		restDatasourceConstraintMockMvc
				.perform(post("/api/datasource-constraints").contentType(TestUtil.APPLICATION_JSON_UTF8)
		...
		DatasourceConstraint testDatasourceConstraint = datasourceConstraintList
				.get(datasourceConstraintList.size() - 1);
	}
	...
	public void getAllDatasourceConstraints() throws Exception {
		...
		restDatasourceConstraintMockMvc.perform(get("/api/datasource-constraints")).andExpect(status().isOk())
	...
	public void updateDatasourceConstraint() throws Exception {
		...
		DatasourceConstraint updatedDatasourceConstraint = datasourceConstraintRepository
				.getOne(datasourceConstraint.getId());

		restDatasourceConstraintMockMvc
				.perform(put("/api/datasource-constraints").contentType(TestUtil.APPLICATION_JSON_UTF8)
