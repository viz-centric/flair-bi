...
public class VisualizationColorsResourceIntTest {
    ...
    public void setup() {
        ...
        VisualizationColorsResource visualizationColorsResource = new VisualizationColorsResource(visualizationColorsService);
    ...
    public static VisualizationColors createEntity(EntityManager em) {
        VisualizationColors visualizationColors = new VisualizationColors()
                .code(DEFAULT_CODE);
    ...
    public void createVisualizationColors() throws Exception {
        ...
        restVisualizationColorsMockMvc.perform(post("/api/visualization-colors")
    ...
    public void createVisualizationColorsWithExistingId() throws Exception {
        ...
        VisualizationColorsDTO existingVisualizationColorsDTO = visualizationColorsMapper.visualizationColorsToVisualizationColorsDTO(existingVisualizationColors);
    ...
    public void getAllVisualizationColors() throws Exception {
        ...
        restVisualizationColorsMockMvc.perform(get("/api/visualization-colors?sort=id,desc"))
    ...
    public void updateVisualizationColors() throws Exception {
        ...
        VisualizationColors updatedVisualizationColors = visualizationColorsRepository.findOne(visualizationColors.getId());
        updatedVisualizationColors
                .code(UPDATED_CODE);
        VisualizationColorsDTO visualizationColorsDTO = visualizationColorsMapper.visualizationColorsToVisualizationColorsDTO(updatedVisualizationColors);

        restVisualizationColorsMockMvc.perform(put("/api/visualization-colors")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(visualizationColorsDTO)))
            .andExpect(status().isOk());
