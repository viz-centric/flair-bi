...
public class Hierarchy extends AbstractAuditingEntity {
	...
	@CollectionTable(name = "drilldown", joinColumns = @JoinColumn(name = "hierarchy_id", foreignKey = @ForeignKey(name = "fk_hierarchy_id")))
	...
	public boolean equals(Object o) {
		...
		return new EqualsBuilder().append(getId(), hierarchy.getId()).isEquals();
	}
