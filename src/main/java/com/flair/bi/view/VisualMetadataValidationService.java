...
public class VisualMetadataValidationService {
	...
	public QueryValidationResponseDTO validate(Long datasourceId, QueryDTO queryDTO, String visualMetadataId,
		...
		log.info("Validating grpc query for connection {} visual metadata {} cond expr {} user {}", datasourceId,
				visualMetadataId, queryDTO.getConditionExpressions(), userId);
		return grpcQueryService.sendValidateQuery(datasourceId, queryDTO, visualMetadataId, conditionExpression,
				userId);
	}
}
