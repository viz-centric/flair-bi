...
public class CouchDbConfiguration {
    ...
    public HttpClientFactoryBean httpClientFactoryBean() {
        ...
        Optional.ofNullable(couchDbProperties.getUsername())
            .ifPresent(bean::setUsername);
        Optional.ofNullable(couchDbProperties.getPassword())
            .ifPresent(bean::setPassword);
        ...
        if (couchDbProperties.isEnableSSL()) {
            ...
            try {
                ...
                SSLSocketFactory sslSocketFactory = (SSLSocketFactory) constructor.newInstance(couchDbProperties.getSslFactoryArg());

                bean.setSslSocketFactory(new org.apache.http.conn.ssl.SSLSocketFactory(
                    sslSocketFactory,
    ...
    public StdCouchDbConnector couchDbConnector(@Autowired StdCouchDbInstance instance) {
        ...
        factory.registerObjectMapperConsumer(x -> x.addMixIn(AbstractAuditingEntity.class, AbstractAuditingEntityMixin.class));
