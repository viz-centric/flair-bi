...
public class SelectPropertyType extends PropertyType {
	...
	@OneToOne(cascade = CascadeType.ALL, orphanRemoval = true, mappedBy = "defaultSelectPropertyType")
	...
	public SelectPropertyType removeDefaultValue() {
		Optional.ofNullable(this.getDefaultValue()).ifPresent(x -> x.setDefaultSelectPropertyType(null));
