...
public class FeatureBookmarkResource {
     ...
     * @return the ResponseEntity with status 201 (Created) and with body the new featureBookmark, or with status 400 (Bad Request) if the featureBookmark has already an ID
     ...
     * @return the ResponseEntity with status 200 (OK) and with body the updated featureBookmark,
     * or with status 400 (Bad Request) if the featureBookmark is not valid,
     * or with status 500 (Internal Server Error) if the featureBookmark couldn't be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    ...
    @Timed
    public List<FeatureBookmark> getAllFeatureBookmarks(@QuerydslPredicate(root = FeatureBookmark.class) Predicate predicate) {
     ...
     * @return the ResponseEntity with status 200 (OK) and with body the featureBookmark, or with status 404 (Not Found)
     */
