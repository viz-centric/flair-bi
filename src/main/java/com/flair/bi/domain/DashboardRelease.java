...
public class DashboardRelease extends Release {
    ...
    @JoinTable(name = "dashboard_view_releases",
        joinColumns = @JoinColumn(name = "dashboard_release_id", referencedColumnName = "id"),
        inverseJoinColumns = @JoinColumn(name = "view_release_id", referencedColumnName = "id"))
