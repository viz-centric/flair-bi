...
public class PermissionResourceTest extends AbstractIntegrationTest {
	...
	public void addPermissionToUserGroup() {
		...
		ResponseEntity<UserGroup> response = restTemplate.withBasicAuth("flairuser", "flairpass").exchange(
				getUrl() + "/api/permissions/some_perm_ission/userGroups/someGroup", HttpMethod.PUT,
				new HttpEntity<>(new LinkedMultiValueMap<>()), UserGroup.class);
	...
	public void removePermissionFromUserGroup() {
		...
		ResponseEntity<UserGroup> response = restTemplate.withBasicAuth("flairuser", "flairpass").exchange(
				getUrl() + "/api/permissions/some_perm_ission/userGroups/someGroup", HttpMethod.DELETE,
				new HttpEntity<>(new LinkedMultiValueMap<>()), UserGroup.class);
	...
	public void addPermission() {
		...
		ResponseEntity<ManagedUserVM> response = restTemplate.withBasicAuth("flairuser", "flairpass").exchange(
				getUrl() + "/api/permissions/some_perm_ission/users/login", HttpMethod.PUT,
				new HttpEntity<>(new LinkedMultiValueMap<>()), ManagedUserVM.class);
	...
	public void removePermission() {
		...
		ResponseEntity<ManagedUserVM> response = restTemplate.withBasicAuth("flairuser", "flairpass").exchange(
				getUrl() + "/api/permissions/some_perm_ission/users/login", HttpMethod.DELETE,
				new HttpEntity<>(new LinkedMultiValueMap<>()), ManagedUserVM.class);
