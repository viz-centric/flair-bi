...
public class PermissionResource {
	...
	/**
	 * PUT /permissions/:permission/userGroups/:userGroup : add permission to user
	 * group
	 *
	 * @param permission permission id
	 * @param userGroup  user group name
	 * @return the ResponseEntity with status 200 (OK) or 404 (Not found) if either
	 *         permission or user group was not found
	 */
	@PutMapping("/permissions/{permission}/userGroups/{userGroup}")
	@Timed
	public ResponseEntity<UserGroup> addPermissionToUserGroup(@PathVariable String permission,
	...
	/**
	 * PUT /permissions/:permission/userGroups/:userGroup : removes permission from
	 * user group
	 *
	 * @param permission permission id
	 * @param userGroup  user group name
	...
	@Timed
	public ResponseEntity<UserGroup> removePermissionFromUserGroup(@PathVariable String permission,
			@PathVariable String userGroup) {
	 ...
	 * @return the ResponseEntity with status 200 (OK) or 404 (Not found) if
	 *         permission or user login was not found
	 */
	...
	public ResponseEntity<ManagedUserVM> addPermission(@PathVariable String login, @PathVariable String id) {
		...
		final ManagedUserVM managedUserVM = new ManagedUserVM(
				userService.getUserWithAuthoritiesByLogin(login).orElse(null));
	 ...
	 *         user or permission was not found
	 */
