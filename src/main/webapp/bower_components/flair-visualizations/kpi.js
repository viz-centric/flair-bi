function kpi() {
    ...
    var _config,
         ...
         * will be sent during calling of _baseAccessor function
         */
        _kpiDisplayName = [],
        _kpiAlignment = [],
        _kpiBackgroundColor = [],
    ...
    var _getKpi = function(value, endValue, index) {
        ...
        numberOutput += "<span style='" + style + "'>"
            + UTIL.getNumberFormatter(_kpiNumberFormat[index])(UTIL.roundNumber(value, 0)).toUpperCase()
            + "</span>";
    ...
    chart.kpiDisplayName = function(value, measure) {
        return _baseAccessor.call(_kpiDisplayName, value, measure);
    }
    ...
    chart.kpiAlignment = function(value, measure) {
        return _baseAccessor.call(_kpiAlignment, value, measure);
    }
    ...
    chart.kpiBackgroundColor = function(value, measure) {
        return _baseAccessor.call(_kpiBackgroundColor, value, measure);
    }
    ...
    chart.kpiNumberFormat = function(value, measure) {
        return _baseAccessor.call(_kpiNumberFormat, value, measure);
    }
    ...
    chart.kpiFontStyle = function(value, measure) {
        return _baseAccessor.call(_kpiFontStyle, value, measure);
    }
    ...
    chart.kpiFontWeight = function(value, measure) {
        return _baseAccessor.call(_kpiFontWeight, value, measure);
    }
    ...
    chart.kpiFontSize = function(value, measure) {
        return _baseAccessor.call(_kpiFontSize, value, measure);
    }
    ...
    chart.kpiColor = function(value, measure) {
        return _baseAccessor.call(_kpiColor, value, measure);
    }
    ...
    chart.kpiIcon = function(value, measure) {
        return _baseAccessor.call(_kpiIcon, value, measure);
    }
    ...
    chart.kpiIconFontWeight = function(value, measure) {
        return _baseAccessor.call(_kpiIconFontWeight, value, measure);
    }
    ...
    chart.kpiIconColor = function(value, measure) {
        return _baseAccessor.call(_kpiIconColor, value, measure);
    }
