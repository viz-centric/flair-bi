    ...
    function GenerateClusteredverticalbarChart(VisualizationUtils, $rootScope, D3Utils, filterParametersService) {
        return {
            build: function (record, element, panel) {
                ...
                var Helper = (function() {
                    ...
                    Helper.prototype.toggleSortSelection = function(scope, sortType, callback) {
                        var _onRadioButtonClick = function(event) {
                            ...
                            d3.select(scope.container).select('.clusteredverticalbar-plot').remove();
                ...
                var Clusteredverticalbar = (function() {

                    function Clusteredverticalbar(container, record, properties) {
                        ...
                        $('#clusteredverticalbar-' + this.id).remove();
                        var div = d3.select(container).append('div')
                            .attr('id', 'clusteredverticalbar-' + this.id)
                    ...
                    Clusteredverticalbar.prototype.updateChart = function(data) {
                        var me = this;
                        ...
                        var axisBottom = d3.axisBottom(xScaleDim)
                            .tickFormat(function(d) {
                                if(isRotate==false){
                                    isRotate= D3Utils.getTickRotate(d, (me.contentWidth)/(xLabels.length-1), me.tickLength);
                                }
                                return D3Utils.getTruncatedTick(d,( me.contentWidth)/(xLabels.length - 1), me.tickLength);
                            });
                        ...
                        var axisLeft = d3.axisLeft(yScale)
                            .tickFormat(function(d) {
                                ...
                                return D3Utils.getTruncatedTick(D3Utils.shortScale(2)(d), margin.left - 8, me.tickLength);
                            });

                        container.select('#x_axis').call(axisBottom);
                        container.select('#y_axis').call(axisLeft);
                        ...
                        function afterTransitionNew() {
                            ...
                            text.attr('x', function(d, i) {
                                ...
                                .attr('dy', function(d, i) {
                                    return -me.offsetX/10;
                                })
                                .attr('dx', function(d, i) {
                                    return xScaleMes.bandwidth() / 2;
                                })
                                .text(function(d, i) {
                                    var barWidth = (1 - xScaleDim.padding()) * me.contentWidth / (xLabels.length - 1);
                                    barWidth = (1 - xScaleMes.padding()) * barWidth / me.helper.maxMes;
                                    return D3Utils.getTruncatedTick(d3.select(this).text(), barWidth, me.tickLength);
                                })
                        ...
                        rect.transition(transitionNew)
                            ...
                            d3.selectAll('.clusteredverticalbar-plot .cluster')
                                .attr('transform', function(d) {
                                    return 'translate(' + xScaleDim(d[dimension[0]]) + ', 0)';
                            });
                    ...
                    Clusteredverticalbar.prototype.renderChart = function() {
                        ...
                        var drawLegend = function(data) {
                            ...
                            var legend = container.append('g')
                                .attr('class', 'clusteredverticalbar-legend')
                                ...
                                .enter().append('g')
                                    ...
                                    .on('click', function(d, i) {
                                        ...
                                        d3.select(me.container).select('.clusteredverticalbar-plot').remove();
                            ...
                            function afterTransition() {
                                ...
                                text.attr('x', function(d, i) {
                                    ...
                                    .text(function(d, i) {
                                        ...
                                        barWidth = (1 - xScaleMes.padding()) * barWidth / me.helper.maxMes;
                                        return D3Utils.getTruncatedTick(d3.select(this).text(), barWidth, tickLength);
                                    })
                                    .style('text-anchor', 'middle');
                            }
                ...
                if(Object.keys($rootScope.updateWidget).indexOf(record.id) != -1) {
                    if($rootScope.filterSelection.id != record.id) {
                        ...
                        clusteredverticalbar.updateChart(record.data);
                    }
                } else {
                    var clusteredverticalbar = new Clusteredverticalbar(element[0], record, getProperties(VisualizationUtils, record));
                    clusteredverticalbar.renderChart();
