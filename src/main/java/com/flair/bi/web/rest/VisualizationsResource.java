...
public class VisualizationsResource {
	...
	public ResponseEntity<Visualization> createVisualizations(@Valid @RequestBody Visualization visualization)
	...
	public ResponseEntity<Visualization> updateVisualizations(@Valid @RequestBody Visualization visualization)
			throws URISyntaxException {
	...
	@Timed
	@PreAuthorize("@accessControlManager.hasAccess('VISUALIZATIONS', 'UPDATE', 'APPLICATION')")
	public ResponseEntity<Visualization> createNewFieldType(@PathVariable Long id,
	...
	@Timed
	@PreAuthorize("@accessControlManager.hasAccess('VISUALIZATIONS', 'UPDATE', 'APPLICATION')")
	public ResponseEntity<Visualization> assignPropertyType(@PathVariable Long id,
