...
public class InformationResourceTest extends AbstractIntegrationTest {
	...
	public void getAllInformation() {
		...
		ResponseEntity<Information[]> response = restTemplate.withBasicAuth("flairuser", "flairpass").exchange(
				getUrl() + "/api/information", HttpMethod.GET, new HttpEntity<>(new LinkedMultiValueMap<>()),
				Information[].class);
	...
	public void getAllInformationOnDesktop() {
		...
		ResponseEntity<Information[]> response = restTemplate.withBasicAuth("flairuser", "flairpass").exchange(
				getUrl() + "/api/information/based-on-viewport/true", HttpMethod.GET,
				new HttpEntity<>(new LinkedMultiValueMap<>()), Information[].class);
