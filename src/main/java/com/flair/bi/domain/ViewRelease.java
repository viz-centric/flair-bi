 ...
 * <p>
 * Contains which document in NOSQL refers to this version,
 * which version number and which users are involved in it.
 */
@Getter
@Setter
@AllArgsConstructor
...
public class ViewRelease extends Release {
    ...
    @AttributeOverrides(value = {
        @AttributeOverride(name = "id", column = @Column(name = "release_state_id")),
    ...
    public void preRemove() {
        dashboardReleases
            .forEach(x -> x.getViewReleases().remove(this));
