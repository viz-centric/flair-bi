...
public class ReleaseResourceTest extends AbstractIntegrationTest {
	...
	public void getRequests() {
		...
		ResponseEntity<ReleaseRequestDTO[]> response = restTemplate
				.withBasicAuth("flairuser", "flairpass")
				.exchange(getUrl() + "/api/releases",
						HttpMethod.GET,
	...
	public void getRequest() {
		...
		ResponseEntity<ReleaseRequest> response = restTemplate
				.withBasicAuth("flairuser", "flairpass")
				.exchange(getUrl() + "/api/releases/3",
						HttpMethod.GET,
						new HttpEntity<>(new LinkedMultiValueMap<>()),
	...
	public void approveRequest() {
		ResponseEntity<String> response = restTemplate
				.withBasicAuth("flairuser", "flairpass")
				.exchange(getUrl() + "/api/releases/3/approve",
						HttpMethod.PUT,
						new HttpEntity<>(new LinkedMultiValueMap<>()),
						String.class);
	...
	public void rejectRequest() {
		ResponseEntity<String> response = restTemplate
				.withBasicAuth("flairuser", "flairpass")
				.exchange(getUrl() + "/api/releases/3/reject",
						HttpMethod.PUT,
						new HttpEntity<>(new LinkedMultiValueMap<>()),
						String.class);
