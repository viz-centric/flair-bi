...
@JsonSubTypes({ @JsonSubTypes.Type(value = CheckboxProperty.class, name = "CHECKBOX"),
...
public abstract class Property extends AbstractAuditingEntity implements Serializable {
	...
	@JsonIgnore
	@JoinColumn(name = "field_id", foreignKey = @ForeignKey(name = "fk_field_id"), referencedColumnName = "id")
	...
	public boolean equals(Object o) {
		...
		return new EqualsBuilder().append(getId(), property.getId()).isEquals();
	}
