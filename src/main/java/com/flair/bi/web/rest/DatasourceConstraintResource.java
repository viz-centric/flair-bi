...
public class DatasourceConstraintResource {
	 ...
	 *         datasourceConstraint, or with status 400 (Bad Request) if the
	 *         datasourceConstraint has already an ID
	 * @throws URISyntaxException if the Location URI syntax is incorrect
	 */
	@PostMapping("/datasource-constraints")
	@Timed
	public ResponseEntity<DatasourceConstraint> createDatasourceConstraint(
			@Valid @RequestBody DatasourceConstraint datasourceConstraint) throws URISyntaxException {
		...
		if (datasourceConstraint.getId() != null) {
			return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists",
					"A new datasourceConstraint cannot already have an ID")).body(null);
		}
	 ...
	 *         datasourceConstraint, or with status 400 (Bad Request) if the
	 *         datasourceConstraint is not valid, or with status 500 (Internal
	 *         Server Error) if the datasourceConstraint couldn't be updated
	 * @throws URISyntaxException if the Location URI syntax is incorrect
	 */
	@PutMapping("/datasource-constraints")
	@Timed
	public ResponseEntity<DatasourceConstraint> updateDatasourceConstraint(
			@Valid @RequestBody DatasourceConstraint datasourceConstraint) throws URISyntaxException {
	 ...
	 *         datasourceConstraints in body
	 */
	@GetMapping("/datasource-constraints")
	@Timed
	public List<DatasourceConstraint> getAllDatasourceConstraints(
			@QuerydslPredicate(root = DatasourceConstraint.class) Predicate predicate) {
	 ...
	 *         datasourceConstraint, or with status 404 (Not Found)
	 */
