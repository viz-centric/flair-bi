...
public class VisualMetadata extends AbstractAuditingEntity {
    ...
    public void preInsertUpdate() {
        ...
        if (numberOfRequiredDimensionFields < totalNumberOfRequiredDimensionFields) {
            throw new CustomParameterizedException("VisualMetadata must have atleast " + totalNumberOfRequiredDimensionFields + " dimension fields");
        }

        if (numberOfRequiredMeasureFields < totalNumberOfRequiredMeasureFields) {
            throw new CustomParameterizedException("VisualMetadata must have atleast " + totalNumberOfRequiredMeasureFields + " measure fields");
        }
