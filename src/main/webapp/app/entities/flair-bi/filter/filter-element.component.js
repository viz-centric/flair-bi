(function () {
    ...
    filterElementController.$inject = ['$scope', 'proxyService', 'filterParametersService', 'FilterStateManagerService', '$rootScope', '$filter'];

    function filterElementController($scope, proxyService, filterParametersService, FilterStateManagerService, $rootScope, $filter) {
        var vm = this;
