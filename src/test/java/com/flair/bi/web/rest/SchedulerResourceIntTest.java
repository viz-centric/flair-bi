...
public class SchedulerResourceIntTest extends AbstractIntegrationTest {
	...
	public SchedulerDTO createScheduledObject() {
		...
		reportDTO.setReport_name(
				"Clustered-Vertical-Bar-Chart-90497569e61f113349fb082eb9000341--45d994f6-acad-4103-a87b-b7bf9fbc6c2a4");
	...
	public void schduleReport() throws Exception {
		restSchedulerResourceMockMvc
				.perform(post("/api/schedule").contentType(TestUtil.APPLICATION_JSON_UTF8)
