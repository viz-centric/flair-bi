...
/**
 * Class representing join table between {@link Visualization} and {@link com.flair.bi.domain.propertytype.PropertyType}
 */
...
public class VisualizationPropertyType {
    ...
    @JoinColumn(name = "visualization_id",
        foreignKey = @ForeignKey(name = "fk_visualization_id"),
