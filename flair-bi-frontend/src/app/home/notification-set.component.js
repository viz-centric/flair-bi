        ...
        $promise.then(
            function (response) {
                ...
                if (obj.visualization == "Clustered Vertical Bar Chart" || obj.visualization == "Clustered Horizontal Bar Chart" || obj.visualization == "Stacked Horizontal Bar Chart" || obj.visualization == "Stacked Vertical Bar Chart") {
                    ...
                    result['dimension'] = metaData.report_line_item.dimension.map(v => v.toLowerCase());;;
                    result['measure'] = metaData.report_line_item.measure.map(v => v.toLowerCase());;;
                ...
                if (obj.visualization == "Gauge plot") {
                    ...
                    result['measures'] = metaData.report_line_item.measure.map(v => v.toLowerCase());
